...
* *0*: Like with background_method = *4*, we assume that the average of the Fourier transform squared of the images minus the Fourier transform squared of the average image is equal to 0.5*(A+B). 
